...
function svd_singular_val_creation!(::Type{Val{1}}, e::Vector{Float64}, s::Vector{Float64}, 
                                    ::Matrix{Float64}, V::Matrix{Float64},
...
function svd_singular_val_creation!(::Type{Val{2}}, e::Vector{Float64}, s::Vector{Float64}, 
                                    U::Matrix{Float64}, ::Matrix{Float64},
                                    p::Int, ::Int, iter::Int, k::Int, m::Int, n::Int)
